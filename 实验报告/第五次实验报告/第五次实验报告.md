...
测试对端口号为 80 的 TCP 报文的过滤
![TCP 80](.\image\acl\TCP port=80.png)
除`h4`外，均收到了报文

测试对端口号不为 80 的 TCP 报文的过滤
![TCP 90](.\image\acl\TCP port!=80.png)
除`h4`外，均收到了报文

测试对端口号为 80 的 UDP 报文的过滤
![UDP 80](.\image\acl\UDP port=80.png)
所有主机均未收到报文

测试对端口号不为 80 的 UDP 报文的过滤
![UDP 90](.\image\acl\UDP port!=80.png)
除`h4`外，均收到了报文
