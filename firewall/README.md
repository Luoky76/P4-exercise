...
Using different register arrays makes our design amenable(易控制的) to high-speed P4 targets that typically allow only one access to a register array per packet.
